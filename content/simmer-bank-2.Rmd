...
[`SimPy`](https://pythonhosted.org/SimPy/SimPy_Overview.html) or R's
...
several discussions about it, on GitHub and in the discussion forum.  The
...
indefinitely.  See [GitHub]() for examples.  It also doesn't seem to be possible
to schedule infinite capacity.
