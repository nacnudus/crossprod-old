...
tutorial, *The Bank*, to `simmer`.  This post does the same for [Part II](https://pythonhosted.org/SimPy/Tutorials/TheBank2.html), which introduces tricky concepts for tricky customers.
