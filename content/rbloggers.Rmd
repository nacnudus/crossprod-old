...
[R-Bloggers](http://www.r-bloggers.com/) website by Tal Galili, which syndicates literally
hundreds of R-related blogs (573 at the time of writing).  But the number tends
only to increase.  How many actual posts are there in a given week/month, from
how many different blogs?

## The gist of it

I subscribed to the [R-Bloggers](http://www.r-bloggers.com/) daily digest emails in late 2014, giving me a
